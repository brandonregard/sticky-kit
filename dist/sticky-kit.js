...
(function() {
    ...
    $.fn.stick_in_parent = function(opts) {
        ...
        sticky_class = opts.sticky_class, inner_scrolling = opts.inner_scrolling, parent_selector = opts.parent, offset_top = opts.offset_top, dynamic_offset_top_fn = opts.dynamic_offset_top_fn;
        if (offset_top == null) {
            offset_top = 0;
        }
        ...
        if(dynamic_offset_top_fn == null) {
            dynamic_offset_top_fn = function() { return 0 ;};
        }
        _fn = function(elm, padding_bottom, parent_top, parent_height, top, height, el_float) {
            ...
            tick = function() {
                ...
                last_pos = scroll;
                if (fixed) {
                    will_bottom = scroll + height + offset + dynamic_offset_top_fn() > parent_height + parent_top;
